	...
	<body>
			...
			<div class="container">
				<div class="log">  
					...
					<ul>  
					<li><a href="impuestos.php" ><span>Impuestos</span></a></li>  
					<li><a href="" ><span>Activos Fijos</span></a></li>  
					<li><a href="cotizacion.php"><span>Cotizaciones</span></a></li> 
					<br>     
					<li><a href="facturas.php"><span>Facturas</span></a></li>
					<li><a href=""><span>Pedidos</span></a></li>
					<li><a href="" ><span>Nomina</span></a></li>        
					</ul>
				</div>
