    ...
    var textoBusqueda = $("input#busqueda").val();
     ...
     if (textoBusqueda != "") {
        ...
        $("#resultadoBusqueda").html('<p>JQUERY VACIO</p>');
			...
			<img style="margin-left:48%" src="img/buscar.jpg" width="30px" height="30px" >

				<input class="filtro" type="text" name="busqueda" id="busqueda" value="" placeholder="" maxlength="30" autocomplete="off" onKeyUp="buscar();"> </input>  <!-- filtro de busqueda -->
				...
				<table class="tabla-inventario" border CELLPADDING=10 CELLSPACING=0>
					
					<tr> <th>Nombre</th> <th>Tipo</th> <th>Detalle</th>
					<th>Precio costo</th> <th>Precio final</th>
					</tr>
