...
<head>
	...
	<link rel="StyleSheet" href="css/modal.css" type="css/text">
	...
	<body>
			...
			<div class="container">
				<div class="log">  
					...
					<ul>  
					<li><a class="iva" ><span>IVA</span></a></li>  
					<li><a href="" ><span>ICA</span></a></li>  
					<li><a href=""><span style="font-size:15px;">Impuesto renta</span></a></li> 
				...
				<div class="overlay" id="overlay" style="display:none;"></div>
					...
					<div class="box" id="box">
					 ...
					 <div class="body">
						 <p>
						  ingresa el valor del IVA segun tu pais
						 </p>
						 <form method="post">
						 ...
						 <p style="font-size:15px;">recuerde que de este valor se aumentara el porcentaje de sus facturas</p>
					 </div>
				</div>
